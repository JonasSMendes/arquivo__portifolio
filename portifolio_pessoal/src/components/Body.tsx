                ...
                <div className="card-body ">
                    ...
                    <div className="xl:mt-20 card-actions justify-end">
                        <section className=" flex-1 flex flex-col w-80">
                            ...
                            56.6-24.1a18.64 18.64 0 015 .5c12.2 31.6 4.5 55 2.2 60.8 14.3 16.1 23 36.6 23 61.6 0 88.2-52.4 107.6-102.3 113.3 8 7.1 15.2 21.1 15.2 42.5 0 30.7-.3 55.5-.3
